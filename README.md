...
##### prioritizes job queues that are awaiting CPU time and it should determine which job to be taken from which queue and the amount of time to be allocated for the job.

3.  Describe the benefits of the MLFQ over a plain Round-Robin scheduler.

##### mlfq observes execution and adjusts time alloted
