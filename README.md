...
* manages the processes in a cpu, allocating the time for the processes and when they will be processed

3.  Describe the benefits of the MLFQ over a plain Round-Robin scheduler.

* it gives every processes and fair chance and then arrages them into high priority and low priority making the processing efficient and more useful!
